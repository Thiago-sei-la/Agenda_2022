              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <a href="editar.php?idUp=<?php echo $show->id_contato;?>" title="Editar" class="btn btn-success" ><img  src="svg/edit.png" style="width:25px;"></a>
                    <a href="deletar.php?idDel=<?php echo $show->id_contato;?>" onclick="return confirm('Desejar tirar esse escarnio de vosso banco de dados meu bom lorde ?')" 
